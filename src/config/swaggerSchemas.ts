    ...
    response: {
      201: {
        ...
        properties: {
          ...
          roles: {type: 'array', items: { $ref: 'userRole#' }, description: 'list of user roles',},
          companyRoles: {type: 'array', items: { $ref: 'companyRole#' }, description: 'list of user company roles',},
        },
      },
    },
  } as FastifySchema,
